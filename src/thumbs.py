...
def main():
    a = parse_args()
    CITY = a.city; YEAR_INI = a.year_ini; YEAR_END = a.year_end
    MARGIN_M = a.margin; MPP = a.mpp; OUTROOT = a.outroot
    DEBUG_FIRST = max(0, a.debug_first); LIMIT = a.limit
    ...
    print(f"[AOI] {a.aoi_mode}='{aoi_label}' | area ≈ {area_km2} km² | bounds 25831 = ({minx:.1f}, {miny:.1f}, {maxx:.1f}, {maxy:.1f})")
